...
public class ErrorCheck {
	...
	private String errorInputStyle = new StringBuilder(
			"border: 1px solid #C00;border-top-width: 1px;border-right-width: 1px;border-bottom-width: 1px;border-left-width: 1px;border-top-style: solid;border-right-style: solid;border-bottom-style: solid;border-left-style: solid;border-top-color: #C00;border-right-color: #C00;border-bottom-color: #C00;border-left-color: #C00;")
			.toString();

	private String errorMessagesStyle = new StringBuilder(
			"color: #C00;font-weight: bold;margin: 0 0 0 5px;margin-top: 0px;margin-right: 0px;margin-bottom: 0px;margin-left: 5px;")
			.toString();
